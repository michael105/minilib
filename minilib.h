...
#include "minilib/contrib/qsort.h"
...
#define mini_sprintf
#endif
#ifndef mini_qsort_pp
#define mini_qsort_pp
#endif
#endif
...
// minilib/src/qsort_p.c
#ifdef mini_qsort_p
void qsort_p(void **base, int count, int(*cmp)(void**,void**)) ;
#endif
