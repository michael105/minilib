...
mini_strndup(){ mini_define strndup generate; }
...
mini_strspn(){ mini_define strspn generate; }
...
mini_getegid(){ mini_define getegid generate; }
...
mini_readlink(){ mini_define readlink generate; }
...
mini_strtok_r(){ mini_define strtok_r generate; }
...
mini_strcspn(){ mini_define strcspn generate; }
...
mini_ether_ntoa(){ mini_define ether_ntoa generate; }
...
mini_ctype_functions(){ mini_define ctype_functions generate; }
...
mini_strpbrk(){ mini_define strpbrk generate; }
...
mini_times(){ mini_define times generate; }
