...
mini_reext_match(){ 
  if [ ! -z $1 ]; then echo "#define mini_reext_match $1" 
	else echo  "#define mini_reext_match reext_match"
	fi
}
mini_fsync(){ 
...
mini_re_match(){ 
  if [ ! -z $1 ]; then echo "#define mini_re_match $1" 
	else echo  "#define mini_re_match re_match"
	fi
}
mini__openat(){ 
