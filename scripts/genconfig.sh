...
mini_malloc_safebuf(){ 
  if [ ! -z $1 ]; then echo "#define mini_malloc_safebuf $1" 
	else echo  "#define mini_malloc_safebuf malloc_safebuf"
	fi
}
mini_setvbuf(){ 
...
mini_ext_match2(){ 
  if [ ! -z $1 ]; then echo "#define mini_ext_match2 $1" 
	else echo  "#define mini_ext_match2 ext_match2"
	fi
}
mini_errno(){ 
...
mini_ext_match(){ 
  if [ ! -z $1 ]; then echo "#define mini_ext_match $1" 
	else echo  "#define mini_ext_match ext_match"
	fi
}
mini_prints(){ 
