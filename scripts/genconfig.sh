...
mini_qsort_pp(){ 
  if [ ! -z $1 ]; then echo "#define mini_qsort_pp $1" 
	else echo  "#define mini_qsort_pp qsort_pp"
	fi
}
mini_fcntl(){ 
...
mini_qsort_p(){ 
  if [ ! -z $1 ]; then echo "#define mini_qsort_p $1" 
	else echo  "#define mini_qsort_p qsort_p"
	fi
}
mini_ldiv(){ 
