...
SYSDEF_syscall(_kexec_file_load,5, int kernel_fd,In file included from ./minilib.h:1171,
                 from /dev/fd/63:489,
                 from <command-line>:
./minilib/include/exec.h:17:2: [01;33mwarning: #warning execvpe/execvp do not search the PATH environment [-Wcpp][00m
   17 | #warning execvpe/execvp do not search the PATH environment
      | [00;35m ^~~~~~~[00m
 int initrd_fd, unsigned long cmdline_len, const char *cmdline_ptr, unsigned long flags)
...
static inline int __attribute__((always_inline)) tcsetattr(int fd, int opt, const struct termios *io){
 return(ioctl(fd, 0x5402 +opt, io));In file included from ./minilib.h:1453,
                 from /dev/fd/63:489,
                 from <command-line>:
./minilib/include/exec.h:17:2: [01;33mwarning: #warning execvpe/execvp do not search the PATH environment [-Wcpp][00m
   17 | #warning execvpe/execvp do not search the PATH environment
...
char *strduIn file included from ./minilib.h:2993,
                 from /dev/fd/63:489,
                 from <command-line>:
./minilib/include/exec.h:17:2: [01;33mwarning: #warning execvpe/execvp do not search the PATH environment [-Wcpp][00m
   17 | #warning execvpe/execvp do not search the PATH environment
