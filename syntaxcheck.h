...
#define PARSEOPTS_short(opts,argv,options,unrecognized) ({ DEF_OPTIONS_ENUM_short; int argp=1; for ( int ap=1; argv[ap]; ap++ ){ if ( argv[ap][0] == '-' ){ argp = ap+1; for ( int b=1; argv[ap][b]; b++ ){ int ti; char option; opts |= (ti=1<< ((option=argv[ap][b])-97) ); if ( ! ( (options) & ti ) ){ unrecognized; } } } } argp; } )In file included from ./minilib.h:1925,
                 from /dev/fd/63:477,
                 from <command-line>:
./compat/ioctl.h:14:2: [01;33mwarning: #warning WARNING: compat headers are more or less instable. [-Wcpp][00m
   14 | #warning WARNING: compat headers are more or less instable.
      | [00;35m ^~~~~~~[00m
./compat/ioctl.h:15:2: [01;33mwarning: #warning better include minilib.h, [-Wcpp][00m
   15 | #warning better include minilib.h,
      | [00;35m ^~~~~~~[00m
./compat/ioctl.h:16:2: [01;33mwarning: #warning or use the supplied script mini-gcc [-Wcpp][00m
   16 | #warning or use the supplied script mini-gcc
      | [00;35m ^~~~~~~[00m
