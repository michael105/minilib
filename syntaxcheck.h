...
SYSDEF_syscall(_sched_setattr,3, pid_In file included from ./minilib.h:1120,
                 from /dev/fd/63:498,
                 from <command-line>:
./compat/ioctl.h:14:51: [01;33mwarning: backslash and newline separated by space[00m
   14 | #warning compat headers are more or less instable.\
      |                                                    
./compat/ioctl.h:14:2: [01;33mwarning: #warning compat headers are more or less instable. Better include [36mminilib.h [00mor use mini-gcc, when possible [-Wcpp][00m
   14 | #warning compat headers are more or less instable.\
      | [00;35m ^~~~~~~[00m
t pid, struct sched_attr *attr, unsigned int flags)
