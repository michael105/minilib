...
#define getc(F) fgetc(F)
                 from <command-line>:
[31m./minilib.h:2597:2: error: #else without #if[00m
 2597 | #else
      | [00;35m ^~~~[00m
In file included from /dev/fd/60:414,
                 from <command-line>:
./minilib.h:2615:23: [01;33mwarning: extra tokens at end of #ifdef directive[00m
 2615 | #ifdef LDSCRIPT_script.onlytext
      |                      [00;35m ^[00m
./minilib.h:2690:23: [01;33mwarning: extra tokens at end of #ifdef directive[00m
 2690 | #ifdef LDSCRIPT_script.text_and_bss
      |                      [00;35m ^[00m
[31m./minilib.h:2755:2: error: #endif without #if[00m
 2755 | #endif
      | [00;35m ^~~~~[00m
[31mminilib.h:2597:2: error: #else without #if[00m
 2597 | #else
      | [00;35m ^~~~[00m
minilib.h:2615:23: [01;33mwarning: extra tokens at end of #ifdef directive[00m
 2615 | #ifdef LDSCRIPT_script.onlytext
...
minilib.h:2690:23: [01;33mwarning: extra tokens at end of #ifdef directive[00m
 2690 | #ifdef LDSCRIPT_script.text_and_bss
      |                      [00;35m ^[00m
[31mminilib.h:2755:2: error: #endif without #if[00m
 2755 | #endif
      | [00;35m ^~~~~[00m
 "./minilib.h"
int atoi(char *c);
