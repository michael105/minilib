...
unsigned int rand();
#define select_h 
static inline int volatile __attribute__((always_inline)) select(int fd, volatile fd_set* readfd, volatile fd_set *writefd, volatile fd_set *exceptfd, volatile structIn file included from ./minilib.h:2683,
                 from /dev/fd/63:489,
                 from <command-line>:
./minilib/include/exec.h:17:2: [01;33mwarning: #warning execvpe/execvp do not search the PATH environment [-Wcpp][00m
   17 | #warning execvpe/execvp do not search the PATH environment
...
static inline int execv(const char *pathnameIn file included from ./minilib.h:2733,
                 from /dev/fd/63:489,
                 from <command-line>:
./minilib/include/exec.h:17:2: [01;33mwarning: #warning execvpe/execvp do not search the PATH environment [-Wcpp][00m
   17 | #warning execvpe/execvp do not search the PATH environment
