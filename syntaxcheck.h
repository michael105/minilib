...
// 201 "./minilib/include/syscall_stubs.h"
...
#define select_h 
static int volatile __attribute__((optimize("O0"))) select(volatile int fd, volatile fd_set* readfd, volatile fd_set *writefd, volatile fd_set *exceptfd, volatile struct timeval *wait){
  int ret;
  register long int r10 asm ("r10") = (unsigned long int)exceptfd ; register long int r8 asm ("r8") = (unsigned long int) wait ; asm volatile ("syscall" : "=a" (ret) : "a" ( (23 | 0 ) ) , "D" (16), "S" ((unsigned long int)readfd), "d" ((unsigned long int)writefd), "r" (r10), "r" (r8) : "memory","rcx", "r11" );
  return(ret);
}
// 2261 "./minilib.h" 2
// 2275 "./minilib.h"
