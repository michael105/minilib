...
#define NULL 0
// 62 "./minilib/include/globaldefs.h"
struct utimbuf{
  time_t actime;
  time_t modtime;
};
...
#define BUFSIZ 1024
typedef int FILE;
// 96 "./minilib/include/globaldefs.h"
...
// 113 "./minilib/include/minilib_global.h"
...
// 233 "./minilib/include/syscall_stubs.h"
...
int clone_t(int flags){
  long tid,ptid;
  long ret = clone(0x00000100|0x00000800|0x00008000|
      0x00010000|0x00000200|0x80000000 | flags, 0, &tid, &ptid );
  return(ret);
}
// 2866 "./minilib.h" 2
// 2970 "./minilib.h"
