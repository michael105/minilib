...
static inline int execvpe(const char *file, char *const argv[], char In file included from ./minilib.h:2288,
                 from /dev/fd/63:489,
                 from <command-line>:
...
static inline int execv(const char *pathname, char *const argv[]){
  return( execve( pathname, In file included from ./minilib.h:2963,
                 from /dev/fd/63:489,
                 from <command-line>:
./minilib/include/exec.h:17:2: [01;33mwarning: #warning execvpe/execvp do not search the PATH environment [-Wcpp][00m
   17 | #warning execvpe/execvp do not search the PATH environment
      | [00;35m ^~~~~~~[00m
In file included from ./minilib.h:3138,
                 from /dev/fd/63:489,
                 from <command-line>:
./minilib/include/exec.h:17:2: [01;33mwarning: #warning execvpe/execvp do not search the PATH environment [-Wcpp][00m
   17 | #warning execvpe/execvp do not search the PATH environment
