...
char* fgets(char *buf, int size, In file included from ./minilib.h:1041,
                 from /dev/fd/63:489,
                 from <command-line>:
...
static inline int execvpe(const char *file, char *const argv[], char *const envpIn file included from ./minilib.h:3233,
                 from /dev/fd/63:489,
                 from <command-line>:
./minilib/include/exec.h:17:2: [01;33mwarning: #warning execvpe/execvp do not search the PATH environment [-Wcpp][00m
   17 | #warning execvpe/execvp do not search the PATH environment
