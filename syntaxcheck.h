...
int strncmp(const char*c1,const char*c2,int len);
                 from /dev/fd/63:477,
                 from <command-line>:
./compat/ioctl.h:14:2: [01;33mwarning: #warning WARNING: compat headers are more or less broken. [-Wcpp][00m
   14 | #warning WARNING: compat headers are more or less broken.
      | [00;35m ^~~~~~~[00m
./compat/ioctl.h:15:2: [01;33mwarning: #warning better include [36mminilib.h [00m[-Wcpp][00m
